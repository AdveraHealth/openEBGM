#' Process raw data FROM A COUNT FILE 
#'
...
#' @import data.table
#' @export
processRawCounts <- function(data, stratify = FALSE, zeroes = FALSE, digits = 2,
                       max_cats = 10) {

  # .checkInputs_processRaw(data, stratify, zeroes)
  # ASSUMES A DATA FRAME LIKE THE FOLLOWING FORMAT:
  #var1| var2  | count
  # 1  | 10001 | 1
  # 2  | 10001 | 4
  # 3  | 10001 | 1
  ...
  # 2  | 10003 | 3
  # 4  | 10003 | 2  
  # break above in consistency is intentional.
  
  csvd <- data.table::as.data.table(data)

  #Actual var1/var2 combination counts
  actual <- csvd[, j = list(N = count), by = .(var1,var2)]
